...
export function AnimatedCard2({ className, ...props }: CardProps) {
  return (
    <div
      role="region"
...
export function CardBody2({ className, ...props }: CardProps) {
  return (
    <div
      role="group"
      className={cn(
...
export function CardTitle2({ className, ...props }: CardTitleProps) {
  return (
    <h3
      className={cn(
...
export function CardDescription2({ className, ...props }: CardDescriptionProps) {
  return (
    <p
      className={cn(
...
export function CardVisual2({ className, ...props }: CardProps) {
  return (
    <div
...
export function Visual2({
  ...
  return (
    <>
      ...
      />
      <div className="relative h-[180px] w-[356px] overflow-hidden rounded-t-lg font-poppins">
        <Layer1
          hovered={hovered}
          color={mainColor}
    ...
    >
      <div className="ease-[cubic-bezier(0.6, 0.6, 0, 1)] absolute inset-0 z-[6] flex w-[356px] translate-y-0 items-start justify-center bg-transparent p-4 transition-transform duration-500 group-hover/animated-card:translate-y-full">
        <div className="ease-[cubic-bezier(0.6, 0.6, 0, 1)] rounded-md border border-zinc-200 bg-white/25 px-2 py-1.5 opacity-100 backdrop-blur-sm transition-opacity duration-500 group-hover/animated-card:opacity-0 dark:border-zinc-800 dark:bg-black/25">
          ...
          Regular health checks prevent late diagnosis.
          </p>
        </div>
      </div>
    </div>
...
const Layer4: React.FC<LayerProps> = ({ color, secondaryColor, hovered }) => {
  const items = [
    { id: 1, translateX: "100", translateY: "50", text: "Awareness" },
    { id: 2, translateX: "100", translateY: "-50", text: "Balance" },
    { id: 3, translateX: "125", translateY: "0", text: "Wellness" },
    { id: 4, translateX: "-125", translateY: "0", text: "Gynecology" },
    { id: 5, translateX: "-100", translateY: "50", text: "Check-ups" },
    { id: 6, translateX: "-100", translateY: "-50", text: "Comfort" },
  ];
