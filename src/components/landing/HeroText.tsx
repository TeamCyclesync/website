    ...
    <>
      ...
      >
        <div className="flex flex-col">
          ...
          <h2 className=" flex w-full justify-center overflow-hidden text-center md:pb-4 md:pt-0 md:mb-24 mt-2 mb-16">
          ...
          <p className="[text-shadow:_0_1px_8px_rgb(0_0_0_/_40%)] text-xs md:text-lg text-white max-md:max-w-[500px] max-w-[620px] mx-auto leading-5 font-poppins">
            Track your menstrual cycle, sync wellness tips, and unlock
            personalized insights that align with your body’s natural rhythm.
          </p>
        </div>
        ...
        <div className="flex max-sm:flex-col max-sm:w-full max-md:max-w-[370px] gap-4 mx-auto">
          ...
          >
            <Button
              variant={"outline"}
              className="font-[500] w-3/4 md:w-max hover:scale-105 transition-all duration-300 ease-out"
              size={"xl"}
            >
              Explore
          ...
          >
            <ShimmerButton className="shadow-2xl">
              <span className="whitespace-pre-wrap flex items-center gap-2 text-xs md:text-2xl h-min text-center font-poppins leading-none tracking-tight text-white dark:from-white dark:to-slate-900/10 md:text-sm">
              Download the App
