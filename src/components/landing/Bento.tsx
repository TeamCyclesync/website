...
const Bento = () => {
    ...
    return (
        <div className='p-[1rem] -mt-4 sm:mt-10'>
            ...
            <div className='max-w-[850px] mx-auto grid max-sm:grid-cols-2 max-sm:grid-rows-4 grid-cols-3 grid-rows-3 gap-x-4 gap-y-4'>
                ...
                <IoHourglassOutline className='absolute text-white/30' size={200}/>
                    ...
                    <div className='flex flex-col text-center z-[13]'>
                        <span className='tracking-tighter text-[3rem] font-extrabold text-white text-shadow-200 leading-[50px] group-hover:scale-[1.1] duration-300 transition-all'>20%</span>
                        <span className='text-white font-bold tracking-tight uppercase text-[1rem] text-shadow-200'><span className='text-violet-'>Increase</span> in Productivity</span>
                    </div>
                </div>
                ...
                <div className='max-sm:col-span-2 col-span-2 sm:row-start-1 fully-centered rounded-xl shadow-md hover:shadow-xl hover:scale-[1.02] transition-all dutation-300 ease bg-pink-400 relative group overflow-hidden group'>
                    ...
                    {/* Image */}
                    <div className='absolute h-[250px] w-[250px] left-[-8%] bottom-[-35%] group-hover:left-[-5%] transition-all dutation-300 ease grayscale group-hover:grayscale-0 group-hover:scale-[1.03]'>
                        <Image src={"/assets/running.png"} alt='Women running' height={500} width={600} className='object-cover h-full w-full' />
                    </div>

                    <h3 className='text-[2rem] text-white font-bold tracking-tighter text-right leading-7 text-shadow-200 absolute right-[5%] bottom-[35%]'>
                        Work with your Biology
                    </h3>
                    <p className='absolute bottom-[10%] right-[5%] text-violet-700 tracking-tight font-bold text-[1rem] uppercase'>
                        Not against it
                    </p>
                </div>

                {/* section - 2 */}
                <div className='max-sm:col-span-2 col-span-2 fully-centered bg-white rounded-xl bg-purple-300 relative overflow-hidden group hover:scale-[1.03] transition-all duration-300 ease'>

                    <PiClockCountdownFill size={60} className='text-white drop-shadow-md absolute left-[4%] top-[10%] group-hover:scale-[1.05] transition-all duration-300 ease' />

                    <div className='absolute w-[150px] h-[200px] bottom-[-15%] left-[3%] group-hover:left-[5%] transition-all duration-300 ease grayscale group-hover:grayscale-0 group-hover:scale-[1.03]'>
                    ...
                    <div className='flex flex-col gap-1 absolute right-[5%] top-[15%] text-right'>
                        <h3 className='text-white text-shadow-200 font-bold leading-8 text-[2rem] tracking-tighter'>Track Your Cycles <br />with Ease</h3>
                    </div>  
