...
export const TeamMemberDetails: TeamMemberProps[] = [
  ...
  },
  {
    name: "Sohom Laha",
    designation: "UI/UX Designer",
    vision: "Crafting intuitive and engaging user experiences is my passion. I aim to create designs that not only look beautiful but also enhance the usability and functionality of our products, making them a joy to use for our users.",
