        ...
        >
          ...
          <div className=" p-4 md:p-6 flex flex-col justify-center">
            <div className="grid grid-cols-2 mb-4 items-center">
              <p className="text-gray-200 font-poppins text-base">{formattedDate}</p>
              <div className="flex items-center justify-end">
                <span className="text-purple-500 mr-1 text-3xl">•</span>
                <span className="text-base text-gray-200 font-poppins">{blog.type}</span>
              </div>
            </div>
            <h1 className="text-2xl text-start md:text-3xl tracking-wide font-space font-semibold mb-4 text-gray-100">
              <span className="text-3xl md:text-4xl text-purple-500 font-cat mr-2">“</span>
              {blog.title}
              <span className="text-3xl md:text-4xl text-purple-500 font-cat ml-2">”</span>
            </h1>
            <div className="flex items-center mb-4 group">
              ...
              />
              <p className="text-gray-300 font-play group-hover:text-white">{blog.author}</p>
            </div>
          </div>
        </motion.div>
        <motion.div
